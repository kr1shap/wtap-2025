...
const features = [
  {
    ...
    description: 'Bio, expertise, mentorship goals, and role preference in one sleek card.',
  ...
  },
  {
    ...
    description: 'Optional progress tracking for goals, milestones, and action items.',
        ...
        <section className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base text-[var(--slate)] sm:text-lg">
              Mentor Match is a sleek webapp for new grads to find mentors through curated events, swipe-based
              discovery, and real-time chat. Build your card, match with intent, and schedule sessions without
              the overwhelm.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                className="rounded-full bg-[var(--ink)] px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:-translate-y-0.5 hover:shadow-xl"
                href="#/profile"
              >
                Build your card
              </a>
              <a
                className="rounded-full border border-[var(--ink)]/15 bg-white/70 px-6 py-3 text-sm font-semibold text-[var(--ink)] shadow-sm transition hover:-translate-y-0.5"
                href="#/chat"
              >
                Jump into chat
              </a>
      ...
      <section id="how-it-works" className="mx-auto max-w-6xl px-6 py-16">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <p className="max-w-xl text-sm text-[var(--slate)]">
            Every match is designed to feel like a co-op game: cards, levels, and shared quests that keep momentum
            steady from intro to follow-up.
          </p>
        </div>
        ...
        <div className="rounded-[32px] border border-white/70 bg-white/70 p-10 shadow-xl">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {features.map((feature) => (
              <div key={feature.title} className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-sm">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[32px] border border-white/70 bg-white/90 p-8 shadow-lg">
            ...
            <p className="mt-4 text-sm text-[var(--slate)]">
              Join pop-up sessions, industry mixers, and resume labs. Every event spawns a fresh swipe deck so you can
              connect while the energy is high.
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl bg-[var(--fog)] p-4 text-sm">
                <p className="font-semibold text-[var(--ink)]">Live Sessions</p>
                <p className="mt-2 text-xs text-[var(--slate)]">Small-room breakouts pair you with mentors in real time.</p>
              </div>
              <div className="rounded-2xl bg-[var(--fog)] p-4 text-sm">
          ...
          <div className="grid gap-4">
            <div className="rounded-[28px] border border-white/70 bg-white/90 p-6 shadow-lg">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <span className="rounded-full border border-[var(--ink)]/10 bg-[var(--fog)] px-3 py-1 text-xs">
                  Shared skills
                </span>
                <span className="rounded-full border border-[var(--ink)]/10 bg-[var(--fog)] px-3 py-1 text-xs">
                  Same time zone
        ...
        <div className="rounded-[36px] border border-white/70 bg-white/90 p-10 shadow-xl">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-3xl border border-white/70 bg-[var(--fog)] p-6 shadow-sm">
              ...
              <p className="mt-4 text-sm text-[var(--slate)]">
                Passionate about helping new grads ship their first roadmap and build confidence in cross-functional
                teams.
              </p>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        <div className="rounded-[36px] border border-white/70 bg-[var(--ink)] px-8 py-12 text-white shadow-2xl">
          <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <a
              className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[var(--ink)] shadow-lg transition hover:-translate-y-0.5"
              href="#/profile"
            >
              Get early access
            </a>
